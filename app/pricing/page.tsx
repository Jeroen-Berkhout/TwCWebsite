  ...
  return (
    <section className="section">
      ...
      <div className="mt-16 grid gap-8 md:grid-cols-2">
        <div className="rounded-3xl border border-slate-200 bg-emerald-100 p-8">
          <SessionPriceIcon className="h-8 w-8 text-slate-500" />
          <div className="mt-4 flex items-baseline gap-2">
            <span className="text-3xl font-semibold text-navy">£29.00</span>
          ...
          <p className="mt-3 text-sm text-slate-600">
            ...
            build understanding and confidence. We believe this is a fair price, but we are always happy to discuss what would work best for your family.
          </p>

        </div>

        <div className="rounded-3xl border border-slate-200 bg-blue-100 p-8">
          <LessonReportIcon className="h-8 w-8 text-blue-500" />
      ...
      <div className="mt-8 grid gap-8 md:grid-cols-2">
        <div className="rounded-3xl border border-slate-200 bg-amber-100 p-8">
          <FreeMeetingIcon className="h-8 w-8 text-emerald-500" />
          <h2 className="mt-4 text-xl font-semibold text-navy">
        ...
        <div className="rounded-3xl border border-slate-200 bg-violet-100 p-8">
          <FlexibleTimetableIcon className="h-8 w-8 text-teal-500" />
          <h2 className="mt-4 text-xl font-semibold text-navy">
            Flexible timetable
          </h2>
          <p className="mt-3 text-sm text-slate-600">
      ...
      <div className="mt-8 rounded-3xl border border-slate-200 bg-violet-200 p-8 text-center sm:p-12">
